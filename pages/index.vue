<template>
    <header class="splash-main home">
        ...
        <div>
            ...
            <h3>Genomics, Data Science, Public Health</h3>
            <div class="link-social" style="padding-top:1rem;">
                <a href="https://github.com/k-florek/" aria-label="GitHub"><FontAwesomeIcon :icon="['fab', 'github']" /></a>
